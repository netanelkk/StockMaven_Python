...
Original file is located at
    https://colab.research.google.com/drive/1d3oFY9xertQAbc-eNO4UC8_yPW9umf4o
"""
...
df_data_for_models_n = df_data_for_models[df_data_for_models['Date'] >= pd.to_datetime('2023-03-01')]

df_data_for_models_n

df_data_for_models_n['predicted_y'] = df_data_for_models_n['predicted_y'].replace(0, -1)

import re
from datetime import datetime, timedelta

df_data_for_models_n['Date'] = df_data_for_models_n['Date'] + timedelta(days=1)
...
delete_query = "DELETE FROM stock_prediction"
